...
# proteoforms at score threshold 0.4
proteoforms_score4 <- fread("ProteinTables/proteoforms_score_0.4.txt", header = FALSE, col.names = 'ID')
proteoforms <- proteoforms_score4$ID

# proteoform stats
proteoform_stats <- fread("protein_proteoform_stats.txt")
proteoform_stats_score4 <- subset(proteoform_stats, score_threshold==0.4)
proteoform_stats_score4[,localization_threshold := seq(0, 0.5, 0.05)]
proteoform_stats_score4_pval10 <- subset(proteoform_stats_score4, localization_threshold==0.10)
...
pie_dt <- data.table(id=c('proteoforms','qno proteofroms'), 
                     n=c(proteoform_stats_score4_pval10$n_proteins_proteoforms,
                         proteoform_stats_score4_pval10$n_proteins-proteoform_stats_score4_pval10$n_proteins_proteoforms))
...
pie_dt <- data.table(stat=c('<=',
                               '<',
                               '>'), 
                     n=c(proteoform_stats_score4_pval10$n_proteins_equallyExtreme,
                         proteoform_stats_score4_pval10$n_proteins_moreExtreme,
                         proteoform_stats_score4_pval10$n_proteins_proteoforms - proteoform_stats_score4_pval10$n_proteins_extreme))
